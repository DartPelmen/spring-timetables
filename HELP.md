...
* The original package name 'edu.festu.ivankuznetsov.spring-timetables' is invalid and this project uses 'edu.festu.ivankuznetsov.spring_timetables' instead.
